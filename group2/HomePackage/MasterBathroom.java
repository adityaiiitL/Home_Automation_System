...
public class MasterBathroom extends BathRoom {
    ...
    public MasterBathroom() {
        System.out.println("Adding Master bathroom ...");
        objWashingMachine = new WashingMachine();
        System.out.println("Master bathroom added !!");
        System.out.println();
    }

    public void BathRoomFunctions() {
        System.out.println("|| MASTER BATHROOM FUNCTIONS ||");
        System.out.println();
        ...
        if (choice == 1) {
            ...
            System.out.println("Thank You !! Leaving Master BathRoom !");
            System.out.println();
            return;
        }

        char ch;
        System.out.print("Do you want to use more functions of Master BathRoom (Y/N) : ");
        ch = sc.next().charAt(0);
        System.out.println();
...
//        System.out.println();
        ...
        System.out.println("Master Bathroom security checked !!");
